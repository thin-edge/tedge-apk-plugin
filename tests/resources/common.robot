...
Get Service Logs
    # DeviceLibrary.Get Service Logs    service=tedge
    DeviceLibrary.Execute Command    cmd=tail -n 1000 /var/log/tedge*.log
    # DeviceLibrary.Execute Command    tail -n 1000 /var/log/rc.log
